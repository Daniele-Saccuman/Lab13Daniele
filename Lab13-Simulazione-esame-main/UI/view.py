...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.ddyear = ft.Dropdown(label="Anno", hint_text="Anno da analizzare per gli avvistamenti.",
                                  options=[ft.dropdown.Option(key="None",
                                                              text="Nessun filtro")],
                                  on_change=self._controller.read_anno)
        self.ddshape = ft.Dropdown(label="Shape", hint_text="Shape da analizzare per gli avvistamenti.",
                                   options=[ft.dropdown.Option(key="None",
                                                               text="Nessun filtro")],
